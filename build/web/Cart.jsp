    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function moveToCheckOut() {
                window.location = "checkout?action=checkout";
            }
        </script>
    </head>
    <body>
            ...
            <div class="row">
                <table border="1px">
                    ...
                    <c:forEach var="o" items="${requestScope.cart}">
                        ...
                        <form action="update" method="post">
                            ...
                            <td>
                                ...
                                <input type="hidden" name="or_id" value="${o.or_Id}">
                                <input type="submit" name="Update" value="Update">
                                <input type="button" onclick="deleteById(${o.or_Id})" value="Delete">
                            </td>
                        </form>
                        </tr>
                    ...
                    <tr class="total-row">
                        ...
                        <td><input type="button" value="Check Out" class="checkout" onclick="moveToCheckOut()"></td>
                    </tr>
                </table>
            </div>
        </div>
