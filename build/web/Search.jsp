            ...
            <div class="menu-bar-right">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <c:forEach var="cate" items="${category.all}">
                            <a href="cat?cat_id=${cate.cat_id}&cat_name=${cate.cat_name}">${cate.cat_name}</a>
                        </c:forEach>
                    </div>
                </div>
        ...
        <div class="container search-category">
                <div class="row">
                    <div class="search-category_title">
                        <h3>${sessionScope.searchCategory}</h3>
                    </div>
                </div>

                <div class="row">
                    <c:forEach var="prod" items="${sessionScope.prodList}">
                        <div class="col-md-4">
                            <div class="search-category_item" onclick="moveToItemsPage(${prod.prod_id})">
                                <img src="./images/${prod.thumbnail}">
                                <div class="search-category_item-info">
                                    <p>${prod.prod_name}</p>
